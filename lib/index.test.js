...
[1.0.0]: https://bitbucket.org/nikolajevp/changelog-updater/branches/compare/v1.0.0..v0.1.0
	...
	it('Updates [Unreleased] section for Redmine', () => {
		readFile
			.mockClear()
			.mockImplementation((changelogFileName, format, callback) =>
				callback(
...
[Unreleased]: https://redmine/projects/projectName/repository/diff?utf8=%E2%9C%93&rev=0.1.0&rev_to=HEAD
			`
				)
			);
...
[Unreleased]: https://redmine/projects/projectName/repository/diff?utf8=%E2%9C%93&rev=1.0.0&rev_to=HEAD
[1.0.0]: https://redmine/projects/projectName/repository/diff?utf8=%E2%9C%93&rev=0.1.0&rev_to=1.0.0
			`);
	});
});
